...
class UserAuthEmailService:
    ...
    @staticmethod
    async def send_manufacture_approval_email(
    ...
    @staticmethod
    async def send_manufacture_rejection_email(
        user: User, background_tasks: BackgroundTasks
    ):
        data = {
            "app_name": settings.APP_NAME,
